...
# 增加函数可以导出除了embedding层外的参数并且读取

    def __init__(self, dataset_h5_path, use_domain_tag=False):
...
#modify add_feature_size
    ...
    def forward(self, context, question, context_char=None, question_char=None, context_f=None, question_f=None):
        ...
        #logger.info("context_f length: " + str(context_f.size()))
        #logger.info("question_f length: " + str(question_f.size()))
